...
* Empathy, understand the other person from his perspective, but it does not mean to agree to him.
* Detect and label emotions of others for your own powers. 
* To be understood seems to magically solve all problems.
...
* Being right is not the key for successful negotiation, being mindful is.
...
* If someone is saying "no" to you he then will be open to what you have to say next.
* "No" is not stopping the negotiation, but it will open up opportunities you were not thinking about before.
* Start with "no". Great negotiators seek "no" because that's when the great discussions begin.
* A "no" can be scary if you are not used to it, though. If your biggest fear is "no", then you can't negotiate.
...
* Most of the time deadline unsettle us without a good reason.
* They push to a deal to conclusion.
...
* Tone and body language need to align up what people are saying.
* Deal with it via a labeled question. 
* Liers tend to talk in "them" and "their" and not with "I".
* Also liers tend to talk in complex sentences.
...
* Use an odd number, is which makes you seem like to have thought a lot of the sum and calculated it.
...
* Set an extreme anker. Make the counterpart the illusion to lose something.
...
* Being right isn't the key for a successful negotiation, but having the correct mindset is.
