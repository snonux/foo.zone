...
* 2. Ability to focus.
* 3. Conceptual thinking (intellectual competency).
* 4. Analytical ability (intellectual competency).
...
* *Do less than you can:* Keep the practice from becoming a burden. If mindfulness practice feels like a chore, it's not sustainable.
* *Take one breath a day:* I may be the laziest mindfulness instructor in the world because I tell my students all they need to commit to is one mindful breath a day. Just one. Breathe in and breathe out mindfully, and your commitment for the day is fulfilled; everything else is a bonus. If you commit to one breath a day, you can easily fulfill this commitment and can then preserve the momentum of your practice. 
...
* Formal mindfulness: Gives you better mindfulness gains but also requires discipline.
* Joyful Mindfulness: Gives you fewer mindfulness gains but is far more sustainable.
...
* Strong meta-attention (attention of attention)
* Clarity and vividness of attention
* Both meditations require a balance of effort and relaxation.
...
* 1. Sit comfortably in a position that enables both relaxation and alertness at the same time.
* 2. Shift into focused attention. Focus on the breath or any other object of meditation you choose. Do this for 3 minutes.
* 3. Shift into open attention. Bring your attention to whatever you experience and whatever comes to mind. Do this for 3 minutes.
* 4. Repeat focused attention for 3 minutes and open attention for 3 minutes.
* 5. End by resting the mind. If you like, you can again visualize the breath to be a resting place, or a cushion, or a mattress, and let the mind rest on it. (Long pause).
...
* Initial Access Stage: In this stage, you find yourself able to access a certain state of mind, but you cannot maintain that mind for very long.
* Consolidation Stage: This is when you become able to bring up a state of mind on demand, at a desired intensity and duration. Progress in this stage seems to be an exponential function.
...
* Increase the Resolution: Enhance the precision at which we perceive our emotions, so we can see emotions the moments they arise and cease, and notice subtle changes in between.
* Increase the Brightness and Contrast: Make our perceptions more vivid.
...
* Do not feed the monsters. We cannot stop monsters from arising or force them to leave, but we have the power to stop feeding them (take anger, for example).
* Start every thought with kindness and humor. It is all very funny. So every time I fail, it is a comedy.
...
* Body: Shallow breathing, rapid heartbeat, and feeling sick to the stomach
* Emotions: Experiencing a fight-or-flight response
...
* This person thinks acting this way will make them happy in some way.
...
* 1. Settling Attention: Start with three breaths.
* 2. Negative Emotion: Let's now shift gears into negative emotion for two minutes. Bring to mind a memory of an unhappy event, an experience of frustration, anger, or hurt, or an experience in which you were triggered. See if you can relive the moment and the associated emotions in your mind.
* 3. Managing Negative Emotion: The first two steps are to stop and breathe. Focus the mind on the breath and not reacting to the emotion. Slow, deep breaths can help. Stay in this state for half a minute. Next, notice. Notice the experience in your body. What does an afflictive emotion feel like in the body? Changes in tension or temperature? Experience the emotion without judging and only as a physiological phenomenon. Take a minute to experience the emotion in the body. 
* 4. After that, reflect. Where are the emotions coming from? Is there a history behind it? Is there maybe another person involved? Think about "Everybody wants to be happy. This person thinks acting this way will make them happy in some way." Don't judge it as right or wrong. After 30 more seconds, respond. Bring to mind ways in which you might respond to bring a positive outcome. Take a minute to create that response.
* 5. Return to the present for two minutes. Awareness is back to the breath. In this artificial setting, the process takes only a few minutes. In real life, the whole process may be over in seconds, which may not give you a lot of time to do it right if you do not have sufficient practice. One way to practice this process is to do it retroactively. That means practicing the reflection and response steps after a triggering event is over. 
...
* Happiness that arises from flow is much more sustainable. 
* Happiness arising from higher purpose, in contrast, is highly sustainable. This form of happiness is very resilient and can last for a very long time. 
...
* The work is deeply meaningful for you
* It generates a state of flow in you
...
* Inner calm: Just do a lot of mindfulness meditation, and this aspect will be "automagically" taken care of.
* Emotional resilience: Like all emotional experiences, success and failure manifest most strongly in our bodies. The idea is to become comfortable with experiencing these emotions in our bodies.
* Cognitive resilience

### Meditation on Resilience

* Calming the mind: Start with 3 deep breaths. Bring gentle awareness to the breath, becoming aware of the in and out breaths, and the spaces in between.
* Failure: Let's now shift gears into an experience of failure for 4 minutes. Observe all the associated emotions and see how they manifest in the body for 2 minutes. After that, let us see if we can create the ability to experience all those emotions without aversion for 2 minutes.
* Success: Let's now have more fun and shift gears into an experience of success for 4 minutes. Let us see if we can create the ability to experience all those emotions without grasping.
* Returning to calm: Let us now return to the present for 3 minutes. Check in with your body and how it feels now.
...
* An affective component: "I feel you"
...
* Autonomy: The degree of control that an organism can exert over something that creates stress determines whether the stressor alters the organism's functioning. In other words, it's not the stress itself that gets to you; it's the feeling of helplessness in the face of that stress.

* Relatedness: The only experience in life that makes people sustainably happy over time is the quality and quantity of social connections.

* Fairness: Never underestimate a person's sense of fairness; it is overwhelming enough that one often may sacrifice their own self-interest for its sake. If you want to influence people, there is no greater power than goodness.
...
* Begin by taking one conscious breath. If this is a particularly sensitive situation, calm your mind with a few minutes of Mindfulness Meditation or Walking Meditation.
* Mindfully reflect that on the receiving end, there are one or more human beings. Human beings just like me. If this is a particularly difficult situation, it may be useful to visualize the receiver or receivers in your mind and to engage in a few minutes of Just Like Me / Loving Kindness exercise.
* Write your e-mail
* Before sending, mindfully reflect on the insight that if the emotional context of your message is unclear, the receiver's brain will just make something up that is likely more negative than you intended. Put yourself in the receiver's shoes, pretend you know nothing about the sender's (your) emotional context, pretend also that you have a negative bias, and read your e-mail. Revise your e-mail if necessary.
* Take one conscious breath before pressing Send. If this is a particularly delicate situation - for example, if you are writing an angry e-mail to your boss or your subordinate - take three slow, conscious breaths before pressing Send. Feel free to change your mind about pressing Send.
...
* Everybody knows that "Exercise is good for me." There is no more debate. While it is true that not everybody takes the trouble to work out, even those who don't work out know that they should and that it would be good for them.
...
* *Difficult Conversations* - It is useful and thin, can be read during a single flight.
* *The Miracle of Mindfulness* by Thich Nhat Hanh - Short and sweet
...
=> http://siybook.com/v/ted_meng Chade-Meng Tan on how compassion can be practiced in a corporate setting
=> http://siybook.com/v/gtalk_dgoleman Daniel Goleman on emotional intelligence
=> http://siybook.com/v/gtalk_jkz Jon Kabat-Zinn on mindfulness
=> http://siybook.com/v/gtalk_rdavidson Richie Davidson on contemplative neuroscience
=> http://siybook.com/v/gtalk_pgolding Philippe Goldin on the neuroscience of emotions
=> http://siybook.com/v/gtalk_tlewis Thomas Lewis on the neuroscience of empathy
=> http://siybook.com/v/gtalk_drock David Rock on your brain at work
=> http://siybook.com/v/gtalk_shinzen Shinzen Young on the science and practice of mindfulness meditation
=> http://siybook.com/v/ted_dpink Dan Pink on the surprising science of motivation
=> http://siybook.com/v/tdd_jbt Jill Bolte Taylor on her "stroke of insight"
