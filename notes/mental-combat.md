...
* Physical training only does not train your mental performance.
* Visualization of success makes you practise hard.
* Visualization of the result of a workout is a big motivational point.
* Increased testosterone increases confidence.
* Once cool and calm Analyse and react.
...
* You won't perform well without self esteem. Instead of beating up yourself, have an objective look at what went wrong and strategize.
* Identify why you were nervous and use it as excitement next time and remember to breathe.
