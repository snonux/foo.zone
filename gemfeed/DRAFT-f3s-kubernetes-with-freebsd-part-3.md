...
* [⇢ f3s: Kubernetes with FreeBSD - Part 3: Protecting from power cuts](#f3s-kubernetes-with-freebsd---part-3-protecting-from-power-cuts)
* [⇢ ⇢ Introduction](#introduction)
* [⇢ ⇢ Changes since last time](#changes-since-last-time)
* [⇢ ⇢ ⇢ FreeBSD upgrade from 14.1 to 14.2](#freebsd-upgrade-from-141-to-142)
* [⇢ ⇢ ⇢ A new home (behind the TV)](#a-new-home-behind-the-tv)
* [⇢ ⇢ The UPS hardware](#the-ups-hardware)
* [⇢ ⇢ Configuring FreeBSD to Work with the UPS](#configuring-freebsd-to-work-with-the-ups)
* [⇢ ⇢ ⇢ USB Device Detection](#usb-device-detection)
* [⇢ ⇢ ⇢ `apcupsd` Installation](#apcupsd-installation)
* [⇢ ⇢ ⇢ UPS Connectivity Test](#ups-connectivity-test)
* [⇢ ⇢ APC Info on Partner Nodes:](#apc-info-on-partner-nodes)
* [⇢ ⇢ ⇢ Installation on partners](#installation-on-partners)
...
[![New hardware placement arrangement](./f3s-kubernetes-with-freebsd-part-3/f3s-changes.jpg "New hardware placement arrangement")](./f3s-kubernetes-with-freebsd-part-3/f3s-changes.jpg)  
