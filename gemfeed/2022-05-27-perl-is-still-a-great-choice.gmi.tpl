...
=> ./2022-05-27-perl-is-still-a-great-choice/regular_expressions.png Comic source: XKCD
...
=> http://modernperlbooks.com Modern Perl
=> https://hop.perl.plover.com Higher Order Perl
...
=> https://en.wikipedia.org/wiki/Just_another_Perl_hacker JAPH
=> http://www.cpan.org/misc/japh
=> https://www.perlmonks.org/index.pl?next=20;node_id=1590 Perl Poetry

Even I personally have written some poetry in Perl and experimented with a polyglot script:

=> ./2008-06-26-perl-poetry.gmi My very own Perl Poetry
=> ./2014-03-24-the-fibonacci.pl.c-polyglot.gmi A Perl-Raku-C polyglot generating the Fibonacci sequence
...
=> https://perldoc.perl.org/feature Perl feature pragmas
...
=> https://nostarch.com/perloneliners Perl one-liners
=> http://regex.info/book.html Mastering Regular Expressions
=> https://en.wikipedia.org/wiki/Taint_checking Taint checking
...
=> https://github.com/Ovid/Cor Cor - Bringing modern OOP to the Perl Core
