...
=> ./2024-02-04-from-babylon5.buetow.org-to-.cloud.gmi My personal AWS setup
...
=> ./2023-10-29-kiss-static-web-photo-albums-with-photoalbum.sh.gmi KISS static web photo albums with `photoalbum.sh`
...
=> ./2010-05-09-the-fype-programming-language.gmi The Fype Programming Language
...
=> ./2022-04-10-creative-universe.gmi Creative universe (Work pet project contests)
...
=> ./2022-06-15-sweating-the-small-stuff.gmi Sweating the small stuff - Tiny projects of mine
