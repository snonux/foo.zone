...
* [⇢ ⇢ ⇢ Configuring Alloy](#configuring-alloy)
* [⇢ ⇢ ⇢ Adding Loki as a Grafana data source](#adding-loki-as-a-grafana-data-source)
* [⇢ ⇢ The complete monitoring stack](#the-complete-monitoring-stack)
* [⇢ ⇢ Using the observability stack](#using-the-observability-stack)
* [⇢ ⇢ ⇢ Viewing metrics in Grafana](#viewing-metrics-in-grafana)
* [⇢ ⇢ ⇢ Querying logs with LogQL](#querying-logs-with-logql)
* [⇢ ⇢ ⇢ Creating alerts](#creating-alerts)
* [⇢ ⇢ Monitoring external FreeBSD hosts](#monitoring-external-freebsd-hosts)
* [⇢ ⇢ ⇢ Installing Node Exporter on FreeBSD](#installing-node-exporter-on-freebsd)
* [⇢ ⇢ ⇢ Adding FreeBSD hosts to Prometheus](#adding-freebsd-hosts-to-prometheus)
* [⇢ ⇢ ⇢ FreeBSD memory metrics compatibility](#freebsd-memory-metrics-compatibility)
* [⇢ ⇢ ⇢ Disk I/O metrics limitation](#disk-io-metrics-limitation)
* [⇢ ⇢ ZFS Monitoring for FreeBSD Servers](#zfs-monitoring-for-freebsd-servers)
* [⇢ ⇢ ⇢ Node Exporter ZFS Collector](#node-exporter-zfs-collector)
* [⇢ ⇢ ⇢ Verifying ZFS Metrics](#verifying-zfs-metrics)
* [⇢ ⇢ ⇢ ZFS Recording Rules](#zfs-recording-rules)
...
[f3s: Kubernetes with FreeBSD - Part 6: Storage](./2025-07-14-f3s-kubernetes-with-freebsd-part-6.md)  
...
[![Exploring logs in Grafana with Loki](./f3s-kubernetes-with-freebsd-part-8/loki-explore.png "Exploring logs in Grafana with Loki")](./f3s-kubernetes-with-freebsd-part-8/loki-explore.png)  
...
[![FreeBSD hosts in the Node Exporter dashboard](./f3s-kubernetes-with-freebsd-part-8/grafana-freebsd-nodes.png "FreeBSD hosts in the Node Exporter dashboard")](./f3s-kubernetes-with-freebsd-part-8/grafana-freebsd-nodes.png)  
...
[![ZFS datasets table and ARC data vs metadata breakdown](./f3s-kubernetes-with-freebsd-part-8/grafana-zfs-datasets.png "ZFS datasets table and ARC data vs metadata breakdown")](./f3s-kubernetes-with-freebsd-part-8/grafana-zfs-datasets.png)  
