...
=> ./f3s-kubernetes-with-freebsd-part-9/argocd-app-tree.png ArgoCD Application Resource Tree
...
=> ./f3s-kubernetes-with-freebsd-part-9/argocd-login.png ArgoCD login page
...
=> ./f3s-kubernetes-with-freebsd-part-9/argocd-apps-list.png ArgoCD managing all 30 applications in the f3s cluster
