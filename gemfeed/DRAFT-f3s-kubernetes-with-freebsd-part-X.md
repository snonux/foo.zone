...
* [⇢ f3s: Kubernetes with FreeBSD - Part X: GitOps with ArgoCD](#f3s-kubernetes-with-freebsd---part-x-gitops-with-argocd)
* [⇢ ⇢ Introduction](#introduction)
* [⇢ ⇢ What is GitOps?](#what-is-gitops)
* [⇢ ⇢ What is ArgoCD?](#what-is-argocd)
* [⇢ ⇢ Why ArgoCD for f3s?](#why-argocd-for-f3s)
* [⇢ ⇢ Deploying ArgoCD](#deploying-argocd)
* [⇢ ⇢ ⇢ Prerequisites](#prerequisites)
* [⇢ ⇢ ⇢ Installing ArgoCD](#installing-argocd)
* [⇢ ⇢ ⇢ Accessing ArgoCD](#accessing-argocd)
* [⇢ ⇢ ArgoCD Application Structure](#argocd-application-structure)
* [⇢ ⇢ Repository Organization](#repository-organization)
* [⇢ ⇢ Migration Strategy: Incremental, One App at a Time](#migration-strategy-incremental-one-app-at-a-time)
* [⇢ ⇢ ⇢ Migration Phases](#migration-phases)
* [⇢ ⇢ Example Migration: Miniflux](#example-migration-miniflux)
...
* [⇢ ⇢ ⇢ 3. Drift Detection and Self-Healing](#3-drift-detection-and-self-healing)
* [⇢ ⇢ ⇢ 4. Easy Rollbacks](#4-easy-rollbacks)
* [⇢ ⇢ ⇢ 5. Disaster Recovery](#5-disaster-recovery)
* [⇢ ⇢ ⇢ 6. Documentation by Default](#6-documentation-by-default)
* [⇢ ⇢ ⇢ 7. Safe Experimentation](#7-safe-experimentation)
* [⇢ ⇢ Challenges and Solutions](#challenges-and-solutions)
* [⇢ ⇢ ⇢ Challenge 1: Helm Release Adoption](#challenge-1-helm-release-adoption)
* [⇢ ⇢ ⇢ Challenge 2: Persistent Volumes Not Tracked by Helm](#challenge-2-persistent-volumes-not-tracked-by-helm)
* [⇢ ⇢ ⇢ Challenge 3: Secrets Management](#challenge-3-secrets-management)
* [⇢ ⇢ ⇢ Challenge 4: Grafana Not Reloading Datasources](#challenge-4-grafana-not-reloading-datasources)
* [⇢ ⇢ ⇢ Challenge 5: Prometheus With Multiple Sources](#challenge-5-prometheus-with-multiple-sources)
* [⇢ ⇢ ⇢ Challenge 6: Sync Ordering for Prometheus](#challenge-6-sync-ordering-for-prometheus)
...
[ArgoCD Web UI](https://argocd.f3s.buetow.org)  
...
[![ArgoCD Applications List](./f3s-kubernetes-with-freebsd-part-X/argocd-apps-list.png "ArgoCD Applications List")](./f3s-kubernetes-with-freebsd-part-X/argocd-apps-list.png)  
