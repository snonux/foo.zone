...
[![ZFS monitoring dashboard in Grafana showing pool statistics and ARC cache metrics](./f3s-kubernetes-with-freebsd-part-8b/grafana-zfs-dashboard.png "ZFS monitoring dashboard in Grafana showing pool statistics and ARC cache metrics")](./f3s-kubernetes-with-freebsd-part-8b/grafana-zfs-dashboard.png)  
...
[https://grafana.f3s.buetow.org](https://grafana.f3s.buetow.org)  
...
[prometheus configuration on Codeberg](https://codeberg.org/snonux/conf/src/branch/master/f3s/prometheus)  
...
[![Distributed trace visualization in Grafana Tempo showing Frontend → Middleware → Backend spans](./f3s-kubernetes-with-freebsd-part-8b/grafana-tempo-trace.png "Distributed trace visualization in Grafana Tempo showing Frontend → Middleware → Backend spans")](./f3s-kubernetes-with-freebsd-part-8b/grafana-tempo-trace.png)  
...
[X-RAG Observability Hackathon (includes service graph screenshots)](https://foo.zone/gemfeed/2025-12-24-x-rag-observability-hackathon.html)  
