...
=> ./2025-12-07-f3s-kubernetes-with-freebsd-part-8.gmi Part 8: Observability (Prometheus, Grafana, Loki, Alloy)
...
=> ./f3s-kubernetes-with-freebsd-part-8/grafana-tempo-trace.png Distributed trace in Grafana Tempo: Frontend -> Middleware -> Backend

More Tempo trace screenshots in the X-RAG blog post:

=> https://foo.zone/gemfeed/2025-12-24-x-rag-observability-hackathon.html X-RAG Observability Hackathon
...
=> https://github.com/snonux/conf/src/branch/master/f3s/tracing-demo Demo tracing application
