...
* [⇢ f3s: Kubernetes with FreeBSD - Part 4: Rocky Linux Bhyve VMs](#f3s-kubernetes-with-freebsd---part-4-rocky-linux-bhyve-vms)
...
* [⇢ ⇢ ⇢ Increase of the disk image](#increase-of-the-disk-image)
* [⇢ ⇢ ⇢ Connect to VNC](#connect-to-vnc)
* [⇢ ⇢ After install](#after-install)
* [⇢ ⇢ ⇢ VM auto-start after host reboot](#vm-auto-start-after-host-reboot)
* [⇢ ⇢ ⇢ Static IP configuration](#static-ip-configuration)
* [⇢ ⇢ ⇢ Permitting root login](#permitting-root-login)
* [⇢ ⇢ ⇢ Install latest updates](#install-latest-updates)
* [⇢ ⇢ Stress testing CPU](#stress-testing-cpu)
* [⇢ ⇢ ⇢ Silly FreeBSD host benchmark](#silly-freebsd-host-benchmark)
* [⇢ ⇢ ⇢ Silly Rocky Linux VM @ Bhyve benchmark](#silly-rocky-linux-vm--bhyve-benchmark)
* [⇢ ⇢ ⇢ Silly FreeBSD VM @ Bhyve benchmark](#silly-freebsd-vm--bhyve-benchmark)
* [⇢ ⇢ Benchmarking with `ubench`](#benchmarking-with-ubench)
* [⇢ ⇢ ⇢ FreeBSD host `ubench` benchmark](#freebsd-host-ubench-benchmark)
* [⇢ ⇢ ⇢ FreeBSD VM @ Bhyve `ubench` benchmark](#freebsd-vm--bhyve-ubench-benchmark)
* [⇢ ⇢ ⇢ Rocky Linux VM @ Bhyve `ubench` benchmark](#rocky-linux-vm--bhyve-ubench-benchmark)
* [⇢ ⇢ Update: Improving Disk I/O Performance for etcd](#update-improving-disk-io-performance-for-etcd)
* [⇢ ⇢ ⇢ The Problem](#the-problem)
* [⇢ ⇢ ⇢ The Solution: Switch to NVMe Emulation](#the-solution-switch-to-nvme-emulation)
* [⇢ ⇢ ⇢ Step 1: Prepare the Guest OS](#step-1-prepare-the-guest-os)
* [⇢ ⇢ ⇢ Step 2: Update the Bhyve Configuration](#step-2-update-the-bhyve-configuration)
...
[![./f3s-kubernetes-with-freebsd-part-4/2.png](./f3s-kubernetes-with-freebsd-part-4/2.png)](./f3s-kubernetes-with-freebsd-part-4/2.png)  
...
[![./f3s-kubernetes-with-freebsd-part-4/3.png](./f3s-kubernetes-with-freebsd-part-4/3.png)](./f3s-kubernetes-with-freebsd-part-4/3.png)  

[![./f3s-kubernetes-with-freebsd-part-4/4.png](./f3s-kubernetes-with-freebsd-part-4/4.png)](./f3s-kubernetes-with-freebsd-part-4/4.png)  
...
[https://codeberg.org/snonux/sillybench](https://codeberg.org/snonux/sillybench)  
