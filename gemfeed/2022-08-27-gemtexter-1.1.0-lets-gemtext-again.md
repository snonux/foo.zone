...
* [⇢ Gemtexter 1.1.0 - Let's Gemtext again](#gemtexter-110---lets-gemtext-again)
...
* [⇢ ⇢ ⇢ Cache for Atom feed generation](#cache-for-atom-feed-generation)
* [⇢ ⇢ ⇢ Input filter support](#input-filter-support)
* [⇢ ⇢ ⇢ Revamped `git` support](#revamped-git-support)
* [⇢ ⇢ ⇢ Addition of `htmlextras` and web font support](#addition-of-htmlextras-and-web-font-support)
