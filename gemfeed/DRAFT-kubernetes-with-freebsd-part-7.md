...
* [⇢ f3s: Kubernetes with FreeBSD - Part 7: First pod deployments](#f3s-kubernetes-with-freebsd---part-7-first-pod-deployments)
* [⇢ ⇢ Introduction](#introduction)
* [⇢ ⇢ Updating](#updating)
* [⇢ ⇢ Installing k3s](#installing-k3s)
* [⇢ ⇢ ⇢ Generating `K3S_TOKEN` and starting first k3s node](#generating-k3stoken-and-starting-first-k3s-node)
