...
[Source code](https://github.com/snonux/ipv6test)  
[Kubernetes manifests](https://github.com/snonux/conf/src/branch/master/f3s/ipv6test)  
[Traefik configuration](https://github.com/snonux/conf/src/branch/master/f3s/traefik-config)  
