...
[![RCM DSL in action](./rcm-ruby-configuration-management-dsl/rcm-dsl.png "RCM DSL in action")](./rcm-ruby-configuration-management-dsl/rcm-dsl.png)  

## Table of Contents

* [⇢ RCM: The Ruby Configuration Management DSL](#rcm-the-ruby-configuration-management-dsl)
* [⇢ ⇢ Why I built RCM](#why-i-built-rcm)
* [⇢ ⇢ How the DSL feels](#how-the-dsl-feels)
* [⇢ ⇢ ⇢ Keywords and resources](#keywords-and-resources)
* [⇢ ⇢ ⇢ Files, directories, and templates](#files-directories-and-templates)
* [⇢ ⇢ How Ruby's metaprogramming helps](#how-ruby-s-metaprogramming-helps)
* [⇢ ⇢ ⇢ A bit more about `method_missing`](#a-bit-more-about-methodmissing)
* [⇢ ⇢ Ruby metaprogramming: further reading](#ruby-metaprogramming-further-reading)
* [⇢ ⇢ Safety, dry runs, and debugging](#safety-dry-runs-and-debugging)
...
[2026-03-02 RCM: The Ruby Configuration Management DSL (You are currently reading this)](./2026-03-02-rcm-ruby-configuration-management-dsl.md)  
